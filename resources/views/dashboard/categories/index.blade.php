                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            &nbsp;<a href="{{route("dashboard.categories.create")}}"  class="btn btn-brand btn-icon-sm" >
                                ...
                                <form method="POST" action="{{route('dashboard.categories.destroy', $category)}}">
                                    ...
                                    <tr data-row="{{$loop->index}}" class="kt-datatable__row" style="left: 0px;">
                                        ...
                                        <span style="overflow: visible; position: relative; width: 100%">
                                            <a href="{{route("dashboard.categories.edit", $category)}}" title="Edit" class="btn btn-sm btn-clean btn-icon btn-icon-md">
