                        ...
                        <div class="kt-login__body">
                            ...
                            <div class="kt-login__signin">
                                ...
                                <div class="kt-login__form">
                                    ...
                                    <form class="kt-form" action="{{route("authenticate")}}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <input value="{{old("email")}}" class="form-control" type="text" placeholder="Email" name="email" autocomplete="off">
                                        </div>
                                        <div class="form-group">
